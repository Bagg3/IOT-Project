...
CREATE SEQUENCE IF NOT EXISTS farm_identifier_seq START WITH 1;
CREATE SEQUENCE IF NOT EXISTS rack_identifier_seq START WITH 1;
CREATE SEQUENCE IF NOT EXISTS species_identifier_seq START WITH 1;
CREATE SEQUENCE IF NOT EXISTS plant_identifier_seq START WITH 1;
CREATE SEQUENCE IF NOT EXISTS sensor_identifier_seq START WITH 1;
CREATE SEQUENCE IF NOT EXISTS actuator_identifier_seq START WITH 1;

CREATE TABLE IF NOT EXISTS farms (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    farm_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'farm_' || LPAD(nextval('farm_identifier_seq')::TEXT, 3, '0')
    ),
...
CREATE TABLE IF NOT EXISTS racks (
    ...
    rack_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'rack_' || LPAD(nextval('rack_identifier_seq')::TEXT, 3, '0')
    ),
    rack_name TEXT,
...
CREATE TABLE IF NOT EXISTS species (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    species_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'species_' || LPAD(nextval('species_identifier_seq')::TEXT, 3, '0')
    ),
...
CREATE TABLE IF NOT EXISTS plants (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    plant_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'plant_' || LPAD(nextval('plant_identifier_seq')::TEXT, 4, '0')
    ),
...
CREATE TABLE IF NOT EXISTS sensors (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    sensor_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'sensor_' || LPAD(nextval('sensor_identifier_seq')::TEXT, 4, '0')
    ),
    plant_location_id UUID NOT NULL REFERENCES plant_locations(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS actuators (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    actuator_identifier TEXT NOT NULL UNIQUE DEFAULT (
        'actuator_' || LPAD(nextval('actuator_identifier_seq')::TEXT, 4, '0')
    ),
    plant_location_id UUID NOT NULL REFERENCES plant_locations(id) ON DELETE CASCADE,
